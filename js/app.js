...
// Declare deck variables
  ...
  // const deck1 = [
  //     {suit: 'club', value: ['2', '3', '4', '5', '6', '7', '8', '9', '10', 'Jack', 'Queen', 'King', 'Ace']}, 
  //     {suit: 'spade', value: ['2', '3', '4', '5', '6', '7', '8', '9', '10', 'Jack', 'Queen', 'King', 'Ace']}, 
  //     {suit: 'heart', value: ['2', '3', '4', '5', '6', '7', '8', '9', '10', 'Jack', 'Queen', 'King', 'Ace']} , 
  //     {suit: 'diamond', value: ['2', '3', '4', '5', '6', '7', '8', '9', '10', 'Jack', 'Queen', 'King', 'Ace']}
  // ]
  ...
  let hitBtn = document.getElementById('hitButton').addEventListener('click', hitHandle)
  ...
  function handleDeal(){
    ...
    for (let i = 0; i < 4; i++) { 
      if (deck1.length > 0) {
        ...
        //console.log("dealer card values", dealerCards)
